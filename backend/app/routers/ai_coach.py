...
from app.ai.coach import chat_with_coach, generate_roadmap, analyze_productivity, generate_interview_questions
...
def chat(
    ...
    response = chat_with_coach(req.message, req.conversation_history)
    if not response:
